...
int main()
{
    ...
    char arr4[] = "CMD+MQTTCONCFG=3,mqtt-harishkumarslm-qcangb,,,,,,,,,\r\n";
    char arr5[] = "CMD+MQTTSTART=1\r\n";
    char arr6[] = "CMD+MQTTSUB=base/state/centimeter\r\n";
//    char arr7[] = "CMD+MQTTPUB=base/state/centimeter\r\n";
...
if (rdlen > 0) {
    ...
    int ret = snprintf(buffer, sizeof(buffer), "CMD+MQTTPUB=base/state/centimeter,%s\r\n", buf);
