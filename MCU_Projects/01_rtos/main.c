...
void sametask(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(normaltask, sametask, osPriorityIdle, 0, 128);
  normaltaskHandle = osThreadCreate(osThread(normaltask), NULL);

  /* definition and creation of hightask02 */
  osThreadDef(hightask02, hightask, osPriorityIdle, 0, 128);
  hightask02Handle = osThreadCreate(osThread(hightask02), NULL);

  /* definition and creation of lowtask03 */
  osThreadDef(lowtask03, lowtask, osPriorityIdle, 0, 128);
...
/* USER CODE BEGIN Header_sametask */
/**
* @brief Function implementing the normaltask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_sametask */
void sametask(void const * argument)
{
  /* USER CODE BEGIN sametask */
  ...
  /* USER CODE END sametask */
}

/* USER CODE BEGIN Header_hightask */
/**
* @brief Function implementing the hightask02 thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the lowtask03 thread.
* @param argument: Not used
* @retval None
*/
